...
//There are warnings for multiple scanners not being closed, but it works fine without closing them.
//I am looking into whether or not they need to be closed with a closing statement or not as I update this file
public class Main {
    public static void main(String[] args) {
        ...
        boss.addHp(65);
        boss.addMagic(7);
        // creation of a new enemy "unemployment" using the same stat types as the
        // character
        ...
        System.out.println("------------------------------------------------");
        System.out.println("~");
        // scanner that takes user inout to put into the switch case
        ...
        System.out.println("------------------------------------------------");
        System.out.println("~");
        // scanner that takes user input to put into the switch case
        ...
        promptEnterKey();
        // if statements based on decisions made prior in the game
        if (alarmclock == 1) {
